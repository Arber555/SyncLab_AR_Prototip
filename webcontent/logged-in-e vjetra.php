    ...
    <body>
        ...
        <div id="create-project" class="create-project">
            <div class="create-project-content">
                ...
                <form name="createproject" method="post">
                    <input type="text" id="project-name" name="projectname" placeholder="Your Project Name">
                    <div id="createproject-error"></div>
                    <input type="button" name="btnP" id="createproject-button" value="Create Project" onclick="Validation()">
                </form>
        ...
        <div id="upload-image" class="upload-image">
            <?php echo filter_input(INPUT_POST, 'projectname'); ?>
            <div class="upload-image-content">
                ...
                <form name="uploadimage" method="post">
                    <label for="upload">Upload image</label>
                    <input type="file" class="upload" name="upload" id="upload" value="Upload image" onchange="PreviewImg(event)">
                    <input type="hidden" name="country" value="<?php echo $projectName; ?>">
                    <div id="uploadimage-error"></div>
                    <input type="submit" id="next-button" value="Next" onclick="Upload()">
                </form>
        ...
        <script>
            ...
            function Validation(){
                ...
                var exit = document.getElementsByClassName("close-upload")[0];
